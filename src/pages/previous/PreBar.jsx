...
// Styles
import "../pending/SideBarPending.css";
// Components
            ...
            <div id="navBar">
                ...
                <Link to="/pending">
                    <div className="nav__link" id="navPending_1">
                        ...
                        <img src={pending} class=" nav__image" alt="pending" />
                        <h2 className="nav__heading ">Pending Confirmation</h2>
                    </div>
                </Link>
                <Link to="/awaiting">
                ...
                <Link to="/previous">
                    <div className="nav__link" id="navPrevious_1">
                       <div id="selectBlock"></div>
                        <img src={previous} class="choosen nav__image" alt="Previous" />
                        <h2 className="nav__heading selected">Previous Projects</h2>
                    </div>
                </Link>
            </div>
            {/* user detail bar */}
